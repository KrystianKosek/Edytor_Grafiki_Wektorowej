...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_panel1->Connect( wxEVT_LEFT_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_MIDDLE_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_RIGHT_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX1_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX2_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX1_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_MOTION, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_MIDDLE_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_RIGHT_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX1_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_AUX2_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_LEAVE_WINDOW, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_ENTER_WINDOW, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Connect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
...
MyFrame1::~MyFrame1()
{
	...
	m_panel1->Disconnect( wxEVT_LEFT_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_MIDDLE_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_MIDDLE_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_RIGHT_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX1_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX1_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX2_DOWN, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX1_UP, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_MOTION, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_MIDDLE_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_RIGHT_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX1_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_AUX2_DCLICK, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_LEAVE_WINDOW, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_ENTER_WINDOW, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
	m_panel1->Disconnect( wxEVT_MOUSEWHEEL, wxMouseEventHandler( MyFrame1::panelOnMouseEvents ), NULL, this );
